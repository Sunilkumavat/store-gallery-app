    ...
    <>
      <div className="min-h-full bg-slate-200">
        ...
        <div className="py-10 ">
          <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900 flex justify-start mb-5">
                Stores Gallery
              </h1>
            </div>
          </header>
          <main className="">
            ...
            <Categories onSelect={setSelectedCategory} className="bg-white shadow-xl min-h-4" />
